<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Tambah Komoditas Barter') }}</h2>
                    ...
                    <form action="{{ route('barter.store') }}" method="POST">
                        ...
                        <div class="grid gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="village" name="village" type="text" class="mt-1 block w-full" value="{{ old('village') }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="estimated_value" name="estimated_value" type="number" class="mt-1 block w-full" value="{{ old('estimated_value', 0) }}" required />
                            ...
                            <div class="flex items-center justify-end gap-4">
                                ...
                                <x-primary-button>{{ __('Simpan Komoditas') }}</x-primary-button>
                            </div>
                        </div>
                    </form>
                </div>
